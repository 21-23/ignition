...
function createSessions() {
    ...
    phoenix.send(stateService.sessionCreate('_qd', participantIds[0], 'rsschool', _qdPuzzleIds.slice(1)));
    phoenix.send(stateService.sessionCreate('_qd', participantIds[0], 'rsschool-demo', [_qdPuzzleIds[0]]));
    ...
    phoenix.send(stateService.sessionCreate('cssqd', participantIds[0], 'rsschool', cssqdPuzzleIds.slice(1)));
    phoenix.send(stateService.sessionCreate('cssqd', participantIds[0], 'rsschool-demo', [cssqdPuzzleIds[0]]));
    ...
    phoenix.send(stateService.sessionCreate('cssqd', participantIds[0], 'dachfest', cssqdPuzzleIds.slice(0, -1)));
    phoenix.send(stateService.sessionCreate('cssqd', participantIds[0], 'dachfest-demo', [cssqdPuzzleIds[0]]));

    phoenix.send(stateService.sessionCreate('jsqd', participantIds[0], 'rsschool', jsqdPuzzleIds.slice(1)));
    phoenix.send(stateService.sessionCreate('jsqd', participantIds[0], 'rsschool-demo', [jsqdPuzzleIds[0]]));
}
