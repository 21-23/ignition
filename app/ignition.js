...
const sessionAliasSuffixes = ['dq', 'kk', 'ms', 'av', 'ay', 'uh', 'ak', 'ab', 'ra', 'op', 'mb', 'sa']; // order here MUST be the same as in ../data/masters.json
...
function createSessions() {
    ...
    phoenix.send(stateService.sessionCreate('jsqd', participantIds[0], 'js-dev-day-dq', jsDevDayJsqdPuzzleIds, 200));
    ...
    phoenix.send(stateService.sessionCreate('jsqd', participantIds[11], 'js-quiz', jsDevDayJsqdPuzzleIds, 200));
    phoenix.send(stateService.sessionCreate('jsqd', participantIds[11], 'js-quiz-demo', [jsDevDayJsqdPuzzleIds[0]], 200));
}
